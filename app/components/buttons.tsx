  ...
  &:not(:only-child) {
    &:nth-child(1) {
      ...
      border-right-color: ${(props) =>
        props.colour === "black" ? "rgba(255,255,255,0.4)" : "rgba(0,0,0,0.4)"};
    }
    &:nth-child(2) {
...
// Button link styles
const ButtonLinkStyle = styled.button<ButtonLinkProps>`
  ${buttonStyles};
`;
...
const ButtonAnchor: React.FC<ButtonAchorProps> = ({
  colour = "white",
  href,
  target = "",
  onClick,
...
export { Button, ButtonLink, ButtonAnchor, Buttons, BaseControlButton };
