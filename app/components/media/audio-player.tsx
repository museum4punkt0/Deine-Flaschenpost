...
export class AudioPlayer extends React.PureComponent<Props, State> {
  ...
  public togglePlay = () => {
    ...
    if (this.audio.paused && this.audio.src) {
      events.track(
        aPlayerPlayPressedEvent(this.props.giftId, this.props.audioReference)
      );
      ...
      events.track(
        aPlayerPausePressedEvent(this.props.giftId, this.props.audioReference)
      );
  ...
  public skipForward = () => {
    ...
    events.track(
      aPlayerSkipPressedEvent(this.props.giftId, this.props.audioReference)
    );

    // Calculate our target
    const target = Math.round(
      this.audio.currentTime + AudioPlayer.skipForwardSeconds
    );
  ...
  public skipBackward = () => {
    ...
    const target = Math.round(
      this.audio.currentTime - AudioPlayer.skipBackwardSeconds
    );
