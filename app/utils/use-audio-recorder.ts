...
const MediaRecorderPolyfill = dynamic(() => import("audio-recorder-polyfill"), {
  ssr: false,
});
...
if (typeof window !== "undefined") {
  MediaRecorder = window.MediaRecorder || MediaRecorderPolyfill;
}
...
type AudioRecorderError = "not-compatible" | "not-allowed" | "recording-error";
...
type State =
  | { kind: "pending" }
  | { kind: "preparing" }
  | { kind: "ready"; recorder: MediaRecorderType }
  | { kind: "recording"; recorder: MediaRecorderType }
  | { kind: "processing"; recorder: MediaRecorderType }
  | { kind: "audio-ready"; recorder: MediaRecorderType; file: LocalFile }
  | { kind: "error"; recorder?: MediaRecorderType; error: AudioRecorderError };
 ...
 * interface.
 */
const UnsupportedGetUserMedia: MediaDevices["getUserMedia"] = () =>
...
const getUserMedia: GetUserMedia = (() => {
  ...
  const wrappedGetUserMedia: GetUserMedia = (constraints) =>
 ...
 */
export const canUseAudioRecorder = () =>
  typeof window !== "undefined" && getUserMedia !== UnsupportedGetUserMedia;
